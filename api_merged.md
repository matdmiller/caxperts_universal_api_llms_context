...
export declare class FileTreeManager {
     ...
     * @returns
     */
    loadUPVF(upfvBase64: string, suppressDefaultAction?: boolean, overwriteFoldersBehavior?: FilesTreeImportBehaviour, overwriteNodesBehavior?: FilesTreeImportBehaviour, keepFolderExpandStates?: boolean, overwriteEnableUi?: boolean): Promise<import("../ResponseTypes").ApiResponse>;
    /**
...
## Internal/APIConnectorBrowser.d.ts
...
## Objects/ApplicationClosingEvent.d.ts
...
## Objects/FilesTreeEventArgs.d.ts
...
export declare class Theme {
    ...
    */
    static getTheme(onThemeAvailable?: (theme: any) => void): Promise<any>;
}
...
declare module '@caxperts/universal.api' {
  ...
  export declare class Application {
      ...
      export declare class ApplicationClosingEvent {
           ...
           * @returns ApiResponse can be ignored and will likely change
           */
          respondToClosing(allowClose: boolean, appName?: string, reason?: string): Promise<ApiResponse>;
      }
      ...
      export declare class ClashContext {
           ...
           * cleans up the clash results from the last clash computation. This should be called after the clash results are consumed to free up resources.
           */
          cleanClashResults(): Promise<ApiResponse>;
          /**
           * @internal
           */
          createCommand(apiCommands: ApiCommands): CaxApiCommand;
